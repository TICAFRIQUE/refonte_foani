                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="categorie_page_id" class="form-select" required>
                                            ...
                                            @foreach ($categories as $categorie)
                                                <option {{ $categorie->id == $page->categorie_page_id ? 'selected' : '' }}
                                                    value="{{ $categorie->id }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-2">
                                            <img src="{{ $page->hasMedia('image') ? $page->getFirstMediaUrl('image') : 'no-image' }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="statut" id="statut" class="form-select">
                                        <option value="1" {{ $page->statut == 1 ? 'selected' : '' }}>Actif</option>
                                        <option value="0" {{ $page->statut == 0 ? 'selected' : '' }}>Inactif</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 d-flex gap-2">
                            <button type="submit" class="btn btn-success px-4 w-75">Modifier</button>
