    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('produit.update', $produit->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        <label for="prix_de_vente" class="form-label">Prix de vente <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="number" step="0.01" name="prix_de_vente" id="prix_de_vente"
                                                class="form-control" value="{{ old('prix_de_vente', $produit->prix_de_vente) }}" required>
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select name="type_reduction" id="type_reduction" class="form-select">
                                                    ...
                                                    <option value="montant" {{ old('type_reduction', $produit->type_reduction) == 'montant' ? 'selected' : '' }}>
                                                        Montant fixe
                                                    </option>
                                                    <option value="pourcentage" {{ old('type_reduction', $produit->type_reduction) == 'pourcentage' ? 'selected' : '' }}>
                                                        Pourcentage
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <select name="visibilite" id="visibilite" class="form-select">
                                            <option value="1" {{ old('visibilite', $produit->visibilite) == 1 ? 'selected' : '' }}>Visible</option>
                                            <option value="0" {{ old('visibilite', $produit->visibilite) == 0 ? 'selected' : '' }}>Caché</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        @php $imgPrincipale = $produit->getFirstMedia('image_principale'); @endphp
                                        <div class="mb-3">
                                            @if($imgPrincipale)
                                                <div class="text-center mb-2">
                                                    <img src="{{ $imgPrincipale->getUrl() }}" class="img-fluid rounded border" style="max-height:200px;">
                                                    <div class="form-check mt-2">
                                                        <input type="checkbox" class="form-check-input" name="supprimer_image_principale" id="supprimer_image_principale" value="1">
                                                        <label class="form-check-label text-danger" for="supprimer_image_principale">Supprimer cette image</label>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="text-center text-muted mb-2" style="font-size:20px;">
                                                    <i class="bi bi-image"></i>
                                                    <p>Aucune image principale</p>
                                                </div>
                                            @endif
                                            <label for="image_principale" class="form-label">Nouvelle image principale</label>
                                            <input type="file" name="image_principale" id="image_principale" class="form-control" accept="image/*">
                                            <div class="form-text">Formats acceptés: JPG, PNG, GIF. Taille max: 1MB</div>
                                            <!-- Aperçu JS comme dans create -->
                                            <div id="preview-principale" class="text-center">
                                                <img id="img-preview-principale" src="" alt="Aperçu" class="img-fluid rounded border" style="max-height: 200px; display: none;">
                                                <div id="default-icon-principale" class="text-muted" style="font-size: 80px;">
                                                    <i class="bi bi-image"></i>
                                                </div>
                                            ...
                                            <div id="images-error-principale" class="text-danger mt-1" style="display:none;"></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- Images multiples -->
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        @php $autresImages = $produit->getMedia('autre_images'); @endphp
                                        <div class="mb-3">
                                            <label class="form-label">Images actuelles</label>
                                            <div class="row g-2">
                                                @foreach($autresImages as $img)
                                                    <div class="col-6">
                                                        <img src="{{ $img->getUrl() }}" class="img-fluid rounded border" style="max-height:120px;">
                                                        <div class="form-check mt-1">
                                                            <input type="checkbox" class="form-check-input" name="supprimer_autres_images[]" value="{{ $img->id }}" id="supprimer_img_{{ $img->id }}">
                                                            <label class="form-check-label text-danger small" for="supprimer_img_{{ $img->id }}">Supprimer</label>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="autre_images[]" id="images" class="form-control" accept="image/*" multiple>
                                            <div class="form-text">Formats acceptés: JPG, PNG, GIF. Taille max par image: 1MB. Max 5 images.</div>
                                        </div>
            ...
            $('#image_principale').on('change', function() {
                ...
                if (file) {
                    if (file.size > 1024 * 1024) {
                        $('#images-error-principale').text("La taille de l'image ne doit pas dépasser 1MB.").show();
                        $(this).val('');
                        img.hide();
                        icon.show();
                        btnRemove.hide();
