 <div id="mainSlider" class="carousel slide mb-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="{{ asset('front/images/sliders/13.jpg') }}" class="d-block w-100"
                    alt="Volaille Fraîche & Locale">
                <div
                    class="carousel-caption-right d-flex flex-column justify-content-center align-items-start text-start p-4">
